...
const std::string kWinName1 = "Original Image";
const std::string kWinName2 = "Converted Image";
const std::string kWinName3 = "Stripe Image";
const std::string kWinName4 = "Marker";
